...
public class RegionController {
    ...
    @ApiImplicitParam(name = "bigScaleRegion", value = "큰 단위 지역 구분 (유의: 세종특별자치시, 제주도)", defaultValue = "세종특별자치시")
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "bigScaleRegion", value = "가장 큰 단위의 지역 구분 (유의: 세종특별자치시, 제주도)", defaultValue = "경기도"),
            @ApiImplicitParam(name = "midScaleRegion", value = "중간 단위 지역 구분 midScaleRegion (특이사례: 고양시덕양구)", defaultValue = "고양시덕양구")
    })
